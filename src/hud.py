...
class HUD:
    ...
    def draw(self, player, inventory, show_tsp_route=True):
        ...
        cd_w = 100
        cd_h = 12
        pygame.draw.rect(self.screen, (30, 30, 80),  (10, 36, cd_w, cd_h))
        pygame.draw.rect(self.screen, (80, 80, 255), (10, 36, int(cd_w * cd_ratio), cd_h))
        pygame.draw.rect(self.screen, (200,200,255), (10, 36, cd_w, cd_h), 1)
        cd_label = self.font.render("DASH [SPC]", True,
                                    (255,255,255) if cd == 0 else (150,150,255))
        self.screen.blit(cd_label, (116, 34))

        # ── Dica inventário ──────────────────────────────────────
        inv_hint = self.font.render("[L] Inventario", True, (200, 200, 200))
        self.screen.blit(inv_hint, (10, 56))

        tsp_status = "ON" if show_tsp_route else "OFF"
